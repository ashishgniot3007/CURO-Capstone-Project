...
export default function Home() {
  ...
  function handleSearch(e) {
    ...
    navigate(
      query
        ? `/doctors?q=${encodeURIComponent(query)}`
        : "/doctors"
    );
  }
    ...
    <>
        ...
        <div className="container-page py-16 sm:py-20 lg:py-24">
          <div className="max-w-3xl">
            <span className="eyebrow">
              Doctor &amp; hospital booking, simplified
            </span>
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-ink-soft">
              CURO books your appointment online or in person with top
              providers in your area, managing your visits and slot
              reservations in one unified, secure platform.
            </p>

            <form
              onSubmit={handleSearch}
              className="mt-8 flex max-w-lg items-center gap-2 rounded-full border border-line bg-white p-1.5 pl-5 shadow-card"
            >
              <svg
                width="16"
                height="16"
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {specialities.slice(0, 5).map((s) => (
                <button
                  ...
                  onClick={() =>
                    navigate(
                      `/doctors?spec=${encodeURIComponent(s)}`
                    )
                  }
        ...
        <div className="container-page py-16 sm:py-20">
          ...
          <div className="mt-10 grid gap-8 sm:grid-cols-3">
            {[
              ...
              <div
                key={step.title}
                className="relative rounded-xl2 border border-line p-6"
              >
        ...
        <div className="container-page grid gap-10 py-14 sm:grid-cols-3">
          <div>
            ...
            <p className="mt-2 text-sm text-teal-100">
              patients served per region, with room to scale.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-teal-100">
              average response time for search and booking.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-teal-100">
              encryption on every medical record and prescription.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container-page py-16 text-center sm:py-20">
        ...
        <p className="mx-auto mt-3 max-w-sm text-sm text-ink-soft">
          Create your CURO profile once, and book with any doctor or
          hospital on the platform after that.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          ...
          <Button to="/doctors" variant="secondary" size="lg">
            Browse doctors
          </Button>
        </div>
      </section>
