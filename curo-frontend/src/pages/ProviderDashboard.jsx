...
import {
  getMyProviderProfile, updateMyProviderProfile, toggleMyProviderActive,
  getMyProviderStats, addSlot, getSlots, listBookings,
} from "../lib/api";
...
export default function ProviderDashboard() {
  ...
  async function loadProfile() {
    ...
    } catch (err) { setMsg({ type: "error", text: err.message || "Failed to load profile" }); }
